...
<!-- hover panel -->
	...
	<aside class="newspan">
		...
		<div>
			...
			<form action="http://kidzou.us2.list-manage.com/subscribe/post?u=a4602e81288a85bf4c061771b&amp;id=1b5be0ebf3" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
				<input type="email" value="" name="EMAIL" class="email" id="mce-EMAIL" placeholder="Adresse mail" required />
				<input type="number" value="" name="CODEPOSTAL" class="required" id="mce-CODEPOSTAL" />

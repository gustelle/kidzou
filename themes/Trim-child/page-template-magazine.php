...
<div id="main_content" class="clearfix<?php if ( $fullwidth ) echo ' fullwidth'; ?>">
	<div id="left_area">
		...
		<article itemscope itemtype="http://schema.org/BlogPosting" id="et_pt_portfolio_gallery" class="clearfix responsive<?php echo $et_ptemplate_portfolio_class; ?>">
			...
			<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
				...
				<?php } ?>
						...
						<section itemprop="blogPost" class="et_pt_portfolio_item">
							<?php if ($et_ptemplate_showtitle) { ?>
								<a alt="<?php echo $et_portfolio_title; ?>" href="<?php the_permalink(); ?>" itemprop="url"><h2 class="et_pt_portfolio_title" itemprop="headline"><?php echo $et_portfolio_title; ?></h2></a>
							<?php } ?>
							<div class="et_pt_portfolio_entry<?php if ( $height == $et_portrait_height ) echo ' et_portrait_layout'; ?>">
								<div class="et_pt_portfolio_image<?php if ($et_videolink <> '') echo ' et_video'; ?>">
										...
										<a alt="<?php echo $et_portfolio_title; ?>" href="<?php the_permalink(); ?>"><?php print_thumbnail($thumb, $thumbnail["use_timthumb"], $titletext, $width, $height, ''); ?></a>

								</div> <!-- end .et_pt_portfolio_image -->
							</div> <!-- end .et_pt_portfolio_entry -->
							<?php if ($et_ptemplate_showdesc) { ?>
								<p><a alt="<?php echo $et_portfolio_title; ?>" href="<?php the_permalink(); ?>"><?php truncate_post(90); ?></a></p>
							<?php } ?>
						</section> <!-- end .et_pt_portfolio_item -->
		...
		</article> <!-- end #et_pt_portfolio_gallery -->

(function($){
	...
	$.et_pb_simple_slider = function(el, options) {
		...
		var $et_slider 			= $(el),
			...
			function et_fix_slider_content_images() {
				...
				var $slide_image_container = $this_slider.find( '.et-pb-active-slide .et_pb_slide_image' );
				var $slide                 = $slide_image_container.closest( '.et_pb_slide' );
				var $slider                = $slide.closest( '.et_pb_slider' );
	...
	var $et_pb_slider  = $( '.et_pb_slider' ),
		...
		$et_pb_filterable_portfolio = $( '.et_pb_filterable_portfolio:not(.kz_pb_filterable_portfolio)' ),
		$kz_pb_filterable_portfolio = $( '.kz_pb_filterable_portfolio' ),
	...
	$(document).ready( function(){
		...
		function et_calculate_header_values() {
			...
			// 	$('#content-spacing').height( $( '#main-header' ).innerHeight());
			// } else {

			...
			defaults: {
				...
				modules : [
					...
					},
					{
						...
						'label' : 'kz_pb_fullwidth_portfolio',
						'fullwidth_only' : 'on'
					},
					{
						'title' : 'Toggle',
					...
					{
						'title' : 'Carte Kidzou Plein Ecran',
						'label' : 'kz_pb_fullwidth_map',
						'fullwidth_only' : 'on'
					},
					{

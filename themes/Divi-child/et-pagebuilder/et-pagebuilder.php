...
function kz_pb_add_custom_box() {
	...
	foreach ( $post_types as $post_type ){
		add_meta_box( 'et_pb_layout', __( 'Page Builder', 'Divi' ), 'kz_pb_pagebuilder_meta_box', $post_type, 'normal', 'high' );
	}
}
...
' %>" />
	...
	<script type="text/template" id="et-builder-kz_pb_blog-module-template">
...
echo <<<END
	...
	<script type="text/template" id="et-builder-kz_pb_portfolio-module-template">
		<h3 class="et-pb-settings-heading">Portfolio Kidzou</h3>
		...
		<div class="et-pb-main-settings">
			...
			<div class="et-pb-option">
				<label for="et_pb_filter">Filtre de navigation: </label>
				<div class="et-pb-option-container">
					<select name="et_pb_filter" id="et_pb_filter">
						<option value="none"<%= typeof( et_pb_filter ) !== 'undefined' && 'none' === et_pb_filter ?  ' selected="selected"' : '' %>>Aucun</option>
						<option value="ville"<%= typeof( et_pb_filter ) !== 'undefined' && 'ville' === et_pb_filter ?  ' selected="selected"' : '' %>>Ville</option>
						<option value="age"<%= typeof( et_pb_filter ) !== 'undefined' && 'age' === et_pb_filter ?  ' selected="selected"' : '' %>>Age</option>
						<option value="divers"<%= typeof( et_pb_filter ) !== 'undefined' && 'divers' === et_pb_filter ?  ' selected="selected"' : '' %>>Famille</option>
						<option value="category"<%= typeof( et_pb_filter ) !== 'undefined' && 'category' === et_pb_filter ?  ' selected="selected"' : '' %>>Category</option>
					</select>
				</div> <!-- .et-pb-option-container -->
			</div> <!-- .et-pb-option -->

			<div class="et-pb-option">
				<label for="et_pb_orderby">Tri des articles: </label>
				<div class="et-pb-option-container">
					<select name="et_pb_orderby" id="et_pb_orderby">
						<option value="publish_date"<%= typeof( et_pb_orderby ) !== 'undefined' && 'publish_date' === et_pb_orderby ?  ' selected="selected"' : '' %>>Ordre naturel (dates de publication)</option>
						<option value="reco"<%= typeof( et_pb_orderby ) !== 'undefined' && 'reco' === et_pb_orderby ?  ' selected="selected"' : '' %>>Nombre de recommandations</option>
						<option value="event_dates"<%= typeof( et_pb_orderby ) !== 'undefined' && 'event_dates' === et_pb_orderby ?  ' selected="selected"' : '' %>>Dates d&apos;&eacute;v&eacute;nement</option>
					</select>
				</div> <!-- .et-pb-option-container -->
			</div> <!-- .et-pb-option -->
...
echo <<<END
	...
	<script type="text/template" id="et-builder-kz_pb_proximite-module-template">
		<h3 class="et-pb-settings-heading">A proximit&eacute;</h3>
	...
	<script type="text/template" id="et-builder-kz_pb_filterable_portfolio-module-template">
...
<script type="text/template" id="et-builder-kz_pb_fullwidth_portfolio-module-template">

...
<body <?php body_class(); ?> <?php if (function_exists('kz_webpage_microdata')) { kz_webpage_microdata();} ?> >
	...
	<noscript>
		...
		<ul class="warning">
			...
			<li>Vous ne pourrez pas visualiser le d&eacute;tail des activit&eacutes; propos&eacute;es sur la Home Page et dans les articles</li>
			<li>Le menu de navigation ne fonctionnera pas correctement</li>
			<li>Vous ne pourrez pas commenter les articles</li>
			<li>L&apos;affichage du site sera d&ecute;grad&eacute;</li>
		...
		<div id="wrapper">
			<header id="main-header" class="clearfix" itemscope itemtype="http://schema.org/WPHeader">
				<div id="top-area">
					...
					<div id="messageBox" data-bind="visible: messageModel.messageContent!=''" class="radius-light warning">
						<span data-bind="html: messageModel.messageContent"></span>
					</div>
					...
					<div class="top">
						...
						<div class="search">
							<form method="get" id="searchform" action="<?php echo esc_url( home_url( '/' ) ); ?>/">
								...
								<input type="search" placeholder="<?php esc_attr_e('On va o&ugrave; &agrave; Lille ?', 'Trim'); ?>" name="s" results=5 autosave='kidzou_search' id="searchinput" title="Entrez des mots tels que week-end ou vacances"   />

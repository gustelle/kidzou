...
(function($){
	...
	$.fn.portamento = function(options) {
		...
		console.log('entered portamento');
		...
		thisWindow.bind("scroll.portamento", function () {
			...
			console.log('thisWindow.height()' + thisWindow.height() + " panel.outerHeight() " + panel.outerHeight() );
			...
			if(thisWindow.height() > panel.outerHeight() && thisWindow.width() >= (thisDocument.width() - ieFix)) { // don't scroll if the window isn't big enough
				...
				if (y >= (topScrollBoundary)) { // if we're at or past the upper scrolling boundary
					...
					console.log('above the top scroll boundary');

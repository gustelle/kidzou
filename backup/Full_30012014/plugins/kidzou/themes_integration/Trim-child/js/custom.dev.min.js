(function($){
	...
	$(document).ready(function(){
		...
		$main_menu.clone().attr('id','mobile_menu').removeClass().addClass("mobile_menu").appendTo( $et_mobile_nav_button );
		$cloned_nav = $et_mobile_nav_button.find('> ul');

		$transverse_menu_li.clone().appendTo( $cloned_nav ); 

		$cloned_nav.find('li').each(function() {
			var this_id = jQuery(this).attr("id");
			jQuery(this).attr("id","m-" + this_id); //pour eviter les ID en doublon 
		});

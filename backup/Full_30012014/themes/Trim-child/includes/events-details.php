				...
				<div class='et-tabs-content-wrapper'>
				    ...
				    <div data-content="info" class="content active et_slidecontent">
						...
						<section class="entry-content">
							...
							<p data-bind="visible: events.selectedEvent().website!=''">
							<!-- ko if: events.selectedEvent().website()!='' -->
								<span class="booticon-share"></span><a title='lien vers le site web du lieu ou se passe l&apos;&eacute;v&eacute;nement' alt='lien vers le site web du lieu ou se passe l&apos;&eacute;v&eacute;nement' data-bind="attr:{href: events.selectedEvent().website()}, text: '&nbsp;Site web de ' + events.selectedEvent().venue()">Lien</a><br/>
							<!-- /ko -->
							<!-- ko if: events.selectedEvent().phone_number()!='' -->
								Tel : <!-- ko text: events.selectedEvent().phone_number() --><!-- /ko -->
							<!-- /ko -->

...
<section id="comment-wrap">
	<?php if ( have_comments() ) : ?>
		...
		<h1 id="comments" itemprop="interactionCount" content="<?php comments_number('0','1','%'); ?> Usercomments"><?php comments_number(esc_html__('0 Visitor Comments','Trim'), esc_html__('1 Visitor Comment','Trim'), '% '.esc_html__('Visitor Comments','Trim') );?></h1>

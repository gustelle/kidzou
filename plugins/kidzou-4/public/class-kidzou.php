...
class Kidzou {
	 ...
	 * @var     string
	 */
	const VERSION = 'HernieDiscale-V2';
	 ...
	 * @var     string
	 */
	public static $version_description = "Refactoring majeur des classes, ajout d'une Extension Chrome pour importer les contenus";

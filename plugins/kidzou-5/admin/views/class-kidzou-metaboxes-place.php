...
class Kidzou_Metaboxes_Place {
	 ...
	 * @var      string
	 */
	public $screen_with_meta_place = array('post'); 
	...
	public function enqueue_geo_scripts()
	{
		...
		$key = Kidzou_Utils::get_option("geo_mapquest_key");
	...
	public function enqueue_styles_scripts() {
		...
		//supprimer les autres instances de 'google-maps-api' eventuellement positionnées par le theme
		//car cela cause des erreurs
		wp_deregister_script('google-maps-api');
		wp_enqueue_script('google-maps-api', 	
				"https://maps.googleapis.com/maps/api/js?libraries=places&key=" . Kidzou_Utils::get_option('googlemaps_key'),
				array() ,
				Kidzou::VERSION, 
				false);

		
		wp_enqueue_script('react-geosuggest', 		plugins_url( 'assets/js/lib/react-geosuggest.min.js', dirname(__FILE__) ), array('react','google-maps-api'), '1.0', true);

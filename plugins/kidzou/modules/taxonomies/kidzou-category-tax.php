...
//see http://en.bainternet.info/2012/wordpress-taxonomies-extra-fields-the-easy-way
...
if (is_admin()){
 ...
 //textarea field
  $my_meta->addTextarea($prefix.'html_code',array('name'=> __('HTML en entête de la catégorie','tax-meta')));
  //checkbox field
  // $my_meta->addCheckbox($prefix.'checkbox_field_id',array('name'=> __('Is Featured ','tax-meta')));
  //select field
  $my_meta->addSelect($prefix.'featured_order',array('0'=>'Non','1'=>'Oui, en 1ere position','2'=>'Oui, en 2e position','3'=>'Oui, en 3e position'),array('name'=> __('Affichage des posts de cette cat&eacute;gorie sur la Home Page ','tax-meta'), 'std'=> array('0')));
  //radio field
  ...
  //Color field
  // $my_meta->addColor($prefix.'color_field_id',array('name'=> __('Couleur Kidzou ','tax-meta')));
  //Image field
  $my_meta->addImage($prefix.'image',array('name'=> __('Image ','tax-meta')));
  //text field
  $my_meta->addText($prefix.'image_link',array('name'=> __('URL de destination de l&apos;image ','tax-meta')));
  //date field
  $my_meta->addDate($prefix.'image_date',array('name'=> __('Date de validit&eacute; de l&apos;image ','tax-meta'), 'format' => 'yy-mm-dd'));
  //file upload field
